...
<head>
    ...
    <meta name="description" content="Portal do Alunos - Acesse suas atividades e recursos escolares">
    ...
    <meta name="apple-mobile-web-app-title" content="Portal Alunos">

    <title>Portal Alunos stgm</title>
</head>
<script>
    tailwind.config = {
        theme: {
...
<style>
    ...
    * {
    ...
    /* Estilo para o alerta de conexão */
    .no-wifi-alert {
        position: fixed;
        top: 20px;
        left: 50%;
...
<body>
        ...
        <div class="container mx-auto px-4 py-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-primary">Portal do <span class="text-secondary">Alunos</span>
                        </h1>
    ...
    <div id="noWifiAlert" class="no-wifi-alert">
        Você não está conectado à internet. Verifique sua conexão e tente novamente.
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const noWifiAlert = document.getElementById('noWifiAlert');

            function checkConnection() {
                if (navigator.connection) {
                    const connectionType = navigator.connection.type;
                    if (connectionType === 'none') {
                        noWifiAlert.classList.add('show');
                        setTimeout(() => {
                            noWifiAlert.classList.remove('show');
                        }, 5000);
                    } else {
                        noWifiAlert.classList.remove('show');
                    }
