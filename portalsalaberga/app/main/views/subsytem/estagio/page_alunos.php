...
<body class="select-none">
    <header class="main-header">
        <div class="container mx-auto px-4 py-3">
            <div class="flex items-center justify-between">
                ...
                <div class="md:hidden">
                    <button id="darkModeToggleMobile" class="inline-flex items-center justify-center p-2 rounded-lg transition-colors">
                        <svg class="w-5 h-5 sun-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
                        </svg>
                        <svg class="w-5 h-5 moon-icon hidden" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <script>
        ...
        const candidates = [
            ...
            { id: 6, name: "BIANCA VIEIRA GOMES", status: "approved", area: "Desenvolvimento", company: "Otica Fênix" },
            ...
            { id: 11, name: "CLRICE ROCHA DE NOJOSA OLIVEIRA", status: "waiting" },
            ...
            { id: 36, name: "MATHEUS FELIX LOPES", status: "approved", area: "Desenvolvimento", company: "DMS LTDA"},
            { id: 37, name: "MATHEUS MACHADO FERNANDES", status: "waiting" },
            { id: 38, name: "MILLENA DA SILVA ANDRADE FREIRES",status: "approved", area: "Midia", company: "Fenix Soluções" },
            ...
            { id: 47, name: "ROGER SILVA CAVALCANTE", status: "approved", area: "Desenvolvimento", company: "DMS LTDA" },
