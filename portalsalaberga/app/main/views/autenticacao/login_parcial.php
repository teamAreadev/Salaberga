...
<body>
    ...
    <div class="main-container">
        ...
        <div class="form-container">
            ...
            <form id="cadastroForm" action="../../controllers/controller_login/controller_login_parcial.php" method="POST"><!--Colocar o arquivo de destino de acordo com a verificação de matricula-->
