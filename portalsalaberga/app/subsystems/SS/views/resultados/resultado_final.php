...
// Cronograma
$pdf->SetY(100); // Posicionando o cronograma mais abaixo
$pdf->SetFillColor(93, 164, 67);
$pdf->SetTextColor(255, 255, 255);
$pdf->SetFont('Arial', 'B', 11);
...
$pdf->Cell($tableWidth, 12, utf8_decode('CRONOGRAMA DE MATRÍCULA PARA CANDIDATOS CLASSIFICADOS (1ª SÉRIE 2025)'), 1, 1, 'C', true);

// Cabeçalho da tabela
$pdf->SetX($xPosCrono);
$pdf->Cell($col1Width, 9, utf8_decode('CURSOS'), 1, 0, 'C', true);
$pdf->Cell($col2Width, 9, utf8_decode('DATA / HORA'), 1, 1, 'C', true);

// Array do Cronograma
$cronograma = [
    'Curso Técnico em Enfermagem' => '06/01/2025 às 8h',
    'Curso Técnico em Informática' => '07/01/2025 às 8h',
    'Curso Técnico em Administração' => '08/01/2025 às 8h',
    'Curso Técnico em Edificações' => '09/01/2025 às 8h'
];
...
// Cronograma
$pdf->SetY(160); // Posicionando o cronograma mais abaixo
$pdf->SetFillColor(93, 164, 67);
$pdf->SetTextColor(255, 255, 255);
$pdf->SetFont('Arial', 'B', 11);
...
// Cabeçalho da tabela
$pdf->SetX($xPosCrono);
$pdf->Cell($col0Width, 9, utf8_decode('DOCUMENTOS NECESSÁRIOS'), 1, 1, 'C', true);
...
foreach ($conteudo as $indice => $informacao) {
    $pdf->multicell(180, 7, utf8_decode($indice." - ".$informacao), 1, 1, 'L', $alt);
    $alt = !$alt;
}
...
$pdf->Cell(18, 6, "", 0, 0, 'L');
$pdf->Cell(0, 6, utf8_decode('RESULTADO FINAL'), 0, 1, 'L');
