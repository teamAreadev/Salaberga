...
<head>
    ...
    <style>
        ...
        * {
        ...
        .informatica { color: #4169E1; }
        .administracao { color: #0dcaf0; }
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
            ...
            <div class="course-card informatica p-8">
                <div class="flex flex-col items-center">
                    ...
                    <div class="w-full space-y-3">
                        <button onclick="informaticaPub()" class="course-btn w-full bg-blue-theme text-white hover:bg-[#4169E1]">
                            <i class="fas fa-school mr-2 text-xs"></i>
                            ESCOLA PÚBLICA
                        </button>
                        <button onclick="informaticaPriv()" class="course-btn w-full bg-blue-theme text-white hover:bg-[#4169E1]">
                            <i class="fas fa-building mr-2 text-xs"></i>
                            ESCOLA PRIVADA
                        </button>
                    </div>
            ...
            <div class="course-card administracao p-8">
                <div class="flex flex-col items-center">
                    ...
                    <div class="w-full space-y-3">
                        <button onclick="administracaoPub()" class="course-btn w-full bg-green-theme text-white hover:bg-[#0dcaf0]">
                            <i class="fas fa-school mr-2 text-xs"></i>
                            ESCOLA PÚBLICA
                        </button>
                        <button onclick="administracaoPriv()" class="course-btn w-full bg-green-theme text-white hover:bg-[#0dcaf0]">
                            <i class="fas fa-building mr-2 text-xs"></i>
                            ESCOLA PRIVADA
                        </button>
                    </div>
