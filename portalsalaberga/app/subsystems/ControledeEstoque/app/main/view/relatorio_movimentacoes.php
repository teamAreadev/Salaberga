...
try {
    ...
    error_log("Erro na página relatorio_movimentacoes.php: " . $e->getMessage());
}
?>
...
<body class="min-h-screen">
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <div class="text-center mb-8">
            <h1 class="text-primary text-3xl md:text-4xl font-bold mb-4 page-title">RELATÓRIO DE MOVIMENTAÇÕES</h1>
            <p class="text-gray-600">Movimentações de estoque por período específico</p>
        </div>
        ...
        <?php if (!empty($data_inicio) && !empty($data_fim)): ?>
            <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="text-center">
                        <h3 class="text-lg font-semibold text-primary">Total de Movimentações</h3>
                        <p class="text-gray-600"><?php echo count($movimentacoes); ?></p>
                    </div>
                    <div class="text-center">
                    ...
                    <table class="w-full">
                        <thead class="bg-primary text-white">
                            <tr>
                                ...
                                <th class="py-3 px-4 text-left">Quantidade Retirada</th>
                            ...
                            <?php if (count($movimentacoes) > 0): ?>
                                <?php foreach ($movimentacoes as $mov): ?>
                                    <tr class="border-b border-gray-200 hover:bg-gray-50">
                                        <td class="py-3 px-4"><?php echo htmlspecialchars($mov['id']); ?></td>
                                        <td class="py-3 px-4"><?php echo htmlspecialchars($mov['nome_produto']); ?></td>
                                        <td class="py-3 px-4"><?php echo htmlspecialchars($mov['barcode_produto']); ?></td>
                                        <td class="py-3 px-4"><?php echo htmlspecialchars($mov['quantidade_retirada']); ?></td>
                                        <td class="py-3 px-4"><?php echo htmlspecialchars($mov['nome_responsavel']); ?></td>
                                        <td class="py-3 px-4"><?php echo htmlspecialchars($mov['cargo']); ?></td>
                                        <td class="py-3 px-4"><?php echo date('d/m/Y H:i', strtotime($mov['datareg'])); ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr>
