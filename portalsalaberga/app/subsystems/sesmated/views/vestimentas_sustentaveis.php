...
<body class="min-h-screen">
    ...
    <main class="container-responsive py-8">
        <div class="flex flex-col items-center justify-center min-h-[70vh]">
            <div class="card-bg rounded-3xl w-full max-w-6xl text-center fade-in">
                ...
                <form id="vestimentasForm" action="../controllers/controller_vestimentas.php" method="post" class="space-y-8">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="criteria-grid">
                            ...
                            <div class="criteria-item">
                                ...
                                <h4 class="criteria-title">Uso de Materiais Sustentáveis</h4>
                                <p class="criteria-subtitle">Pontue de 0 a 100</p>
                                ...
                                <div id="displayMateriais" class="score-display hidden">
                                    <span id="valorMateriais">0</span> pontos
                                </div>
                            </div>
                            ...
                            <div class="criteria-item">
                                ...
                                <h4 class="criteria-title">Criatividade e Design</h4>
                                <p class="criteria-subtitle">Pontue de 0 a 100</p>
                                <div class="score-input-wrapper">
                                    <input 
                                        type="number" 
                            ...
                            <div class="criteria-item">
                                ...
                                <h4 class="criteria-title">Estética e Harmonia Visual</h4>
                                <p class="criteria-subtitle">Pontue de 0 a 100</p>
                                <div class="score-input-wrapper">
                                    <input 
                                        type="number" 
                            ...
                            <div class="criteria-item">
                                ...
                                <h4 class="criteria-title">Identidade com o Curso</h4>
                                <p class="criteria-subtitle">Pontue de 0 a 100</p>
                                <div class="score-input-wrapper">
                                    <input 
                                        type="number" 
                            ...
                            <div class="criteria-item">
                                ...
                                <h4 class="criteria-title">Desfile e Apresentação</h4>
                                <p class="criteria-subtitle">Pontue de 0 a 100</p>
                                <div class="score-input-wrapper">
                                    <input 
                                        type="number" 
                                ...
                                <div id="displayDesfile" class="score-display hidden">
                                    <span id="valorDesfile">0</span> pontos
                                </div>
                            </div>
                            <!-- Acabamento e Estrutura -->
                            <div class="criteria-item">
                                <div class="criteria-icon bg-gradient-to-br from-cyan-500 to-blue-600">
                                    <i class="fas fa-cut"></i>
                                </div>
                                <h4 class="criteria-title">Acabamento e Estrutura</h4>
                                <p class="criteria-subtitle">Pontue de 0 a 100</p>
                                <div class="score-input-wrapper">
                                    <input 
                                        type="number" 
                                        id="notaAcabamento" 
                                        name="nota_acabamento" 
                                        min="0" 
                                        max="100" 
                                        placeholder="0-100"
                                        class="score-input"
                                ...
                                <div id="displayAcabamento" class="score-display hidden">
                                    <span id="valorAcabamento">0</span> pontos
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Tela de Sucesso -->
    <div id="sucessoVestimentas" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm p-4">
        <div class="card-bg rounded-3xl p-8 w-full max-w-md text-center fade-in">
            <div class="flex flex-col items-center gap-4 mb-6">
                ...
                <p class="text-lg text-gray-200">As notas das vestimentas foram computadas com sucesso.</p>
    ...
    <!-- Tela de Erro -->
    <div id="erroVestimentas" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm p-4">
        <div class="card-bg rounded-3xl p-8 w-full max-w-md text-center fade-in">
            <div class="flex flex-col items-center gap-4 mb-6">
    ...
    <div id="jaConfirmadoVestimentas" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm p-4">
        <div class="card-bg rounded-3xl p-8 w-full max-w-md text-center fade-in">
            <div class="flex flex-col items-center gap-4 mb-6">
                ...
                <p class="text-lg text-gray-200">A avaliação destas vestimentas já foi registrada anteriormente.</p>
            </div>
    ...
    <div id="emptyVestimentas" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm p-4">
        <div class="card-bg rounded-3xl p-8 w-full max-w-md text-center fade-in">
            <div class="flex flex-col items-center gap-4 mb-6">
                <div class="w-20 h-20 rounded-2xl bg-gradient-to-br from-red-500 to-red-600 flex items-center justify-center">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const form = document.getElementById('vestimentasForm');
            const pontosPainel = document.getElementById('pontosPainel');
            const voltarButton = document.getElementById('voltarButton');
            // ... (restante do JS igual ao padrão dos outros arquivos, omitido para foco no modal)
            window.fecharSucesso = function() {
                document.getElementById('sucessoVestimentas').classList.add('hidden');
                resetForm();
            };
            function fecharErro() {
                document.getElementById('erroVestimentas').classList.add('hidden');
                resetForm();
            }
            function fecharJaConfirmado() {
                document.getElementById('jaConfirmadoVestimentas').classList.add('hidden');
                resetForm();
            }
            function fecharEmpty() {
                document.getElementById('emptyVestimentas').classList.add('hidden');
                resetForm();
            }
            // Exibir modal conforme status da URL
            var status = '<?php echo $status; ?>';
            if (status === 'sucesso') {
                document.getElementById('sucessoVestimentas').classList.remove('hidden');
                form.style.display = 'none';
                voltarButton.classList.add('hidden');
            } else if (status === 'erro') {
                document.getElementById('erroVestimentas').classList.remove('hidden');
                form.style.display = 'none';
                voltarButton.classList.add('hidden');
            } else if (status === 'ja_confirmado') {
                document.getElementById('jaConfirmadoVestimentas').classList.remove('hidden');
                form.style.display = 'none';
                voltarButton.classList.add('hidden');
            } else if (status === 'empty') {
                document.getElementById('emptyVestimentas').classList.remove('hidden');
                form.style.display = 'none';
                voltarButton.classList.add('hidden');
            }
        });
