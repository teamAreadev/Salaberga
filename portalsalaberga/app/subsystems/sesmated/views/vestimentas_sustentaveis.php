...
<body class="min-h-screen">
    ...
    <main class="container-responsive py-8">
        <div class="flex flex-col items-center justify-center min-h-[70vh]">
            <div class="card-bg rounded-3xl w-full max-w-6xl text-center fade-in">
                ...
                <form action="../controllers/controller_vestimentas.php" method="post" class="space-y-8">
    ...
    <script>
        // (copiar o JS do cordel.php, adaptando para os ids dos critérios de vestimentas)
    </script>
</body>
</html>
