...
class PDF extends connect
{
    ...
    public function main()
    {
        ...
        // Consulta SQL
        $query = "
           SELECT c.nome_curso, a.nome, l.elementos_cursos, l.entrega_a3, l.entrega_digital FROM cursos c INNER JOIN tarefa_04_logomarca l ON l.curso_id = c.curso_id INNER JOIN avaliadores a ON a.id = l.id_avaliador;
        ";
        ...
        $fpdf->Cell(70, 20, utf8_decode('Elementos'), 1, 0, 'C', true);
        $fpdf->Cell(90, 20, utf8_decode('Entrega A3'), 1, 0, 'C', true);
        $fpdf->Cell(120, 20, utf8_decode('Entrega digital'), 1, 1, 'C', true);
        ...
        foreach ($results as $row) {
            ...
            $fpdf->Cell(70, 20, utf8_decode($row['elementos_cursos']), 1, 0, 'C', $fill);
            $fpdf->Cell(90, 20, utf8_decode($row['entrega_a3']), 1, 0, 'C', $fill);
            $fpdf->Cell(120, 20, utf8_decode($row['entrega_digital']), 1, 1, 'C', $fill);
