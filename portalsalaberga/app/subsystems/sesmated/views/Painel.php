    ...
    <header class="header-bg sticky top-0 z-50">
        <div class="container mx-auto px-4 sm:px-6 py-2 sm:py-3">
            <div class="text-center">
                ...
                <p class="text-gray-400 text-sm">"Desenvolvimento econômico, social e sustentável para comunidades resilientes"</p>
                <p class="text-gray-400 text-xs mt-1">Tamanho: 2m x 1,8m</p>
            </div>
        </div>
    </header>
