...
<body class="min-h-screen">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="criteria-grid">
                            ...
                            <div class="criteria-item">
                                ...
                                <h4 class="criteria-title">Letra Adaptada</h4>
                                <p class="criteria-subtitle">Criatividade textual</p>
                                <div class="score-input-wrapper">
                                    <input 
                                        type="number" 
                                        id="notaLetra" 
                                ...
                                <div id="displayLetra" class="score-display hidden">
                                    <span id="valorLetra">0</span> pontos
                                </div>
                            </div>

                            <!-- Dicção, Clareza e Entonação -->
                            <div class="criteria-item">
                                <div class="criteria-icon bg-gradient-to-br from-red-500 to-pink-600">
                                    <i class="fas fa-volume-up"></i>
                                </div>
                                <h4 class="criteria-title">Dicção e Clareza</h4>
                                <p class="criteria-subtitle">Entonação vocal</p>
                                <div class="score-input-wrapper">
                                    <input 
                                        type="number" 
                                        id="notaDiccao" 
                                ...
                                <div id="displayDiccao" class="score-display hidden">
                                    <span id="valorDiccao">0</span> pontos
                                </div>
                            </div>

                            <!-- Desempenho Artístico e Presença de Palco -->
                            <div class="criteria-item">
                                <div class="criteria-icon bg-gradient-to-br from-purple-500 to-violet-600">
                                    <i class="fas fa-theater-masks"></i>
                                </div>
                                <h4 class="criteria-title">Presença de Palco</h4>
                                <p class="criteria-subtitle">Performance artística</p>
                                <div class="score-input-wrapper">
                                    <input 
                                        type="number" 
                                        id="notaDesempenho" 
                                ...
                                <div id="displayDesempenho" class="score-display hidden">
                                    <span id="valorDesempenho">0</span> pontos
                                </div>
                            </div>

                            <!-- Trilha Sonora e Sincronia -->
                            <div class="criteria-item">
                                <div class="criteria-icon bg-gradient-to-br from-indigo-500 to-blue-600">
                                    <i class="fas fa-headphones"></i>
                                </div>
                                <h4 class="criteria-title">Trilha e Sincronia</h4>
                                <p class="criteria-subtitle">Qualidade sonora</p>
                                <div class="score-input-wrapper">
                                    <input 
                                        type="number" 
                                        id="notaTrilha" 
                                ...
                                <div id="displayTrilha" class="score-display hidden">
                                    <span id="valorTrilha">0</span> pontos
                                </div>
                            </div>
    ...
    <!-- Tela de Sucesso -->
    <div id="sucessoParodia" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm p-4">
        <div class="card-bg rounded-3xl p-8 w-full max-w-md text-center fade-in">
            <div class="flex flex-col items-center gap-4 mb-6">
                ...
                <p class="text-lg text-gray-200">As notas da paródia foram computadas com sucesso.</p>
    ...
    <!-- Tela de Erro -->
    <div id="erroParodia" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm p-4">
        <div class="card-bg rounded-3xl p-8 w-full max-w-md text-center fade-in">
            <div class="flex flex-col items-center gap-4 mb-6">
    ...
    <div id="jaConfirmadoParodia" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm p-4">
        <div class="card-bg rounded-3xl p-8 w-full max-w-md text-center fade-in">
            <div class="flex flex-col items-center gap-4 mb-6">
                ...
                <p class="text-lg text-gray-200">A avaliação desta paródia já foi registrada anteriormente.</p>
            </div>
    ...
    <div id="emptyParodia" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm p-4">
        <div class="card-bg rounded-3xl p-8 w-full max-w-md text-center fade-in">
            <div class="flex flex-col items-center gap-4 mb-6">
                <div class="w-20 h-20 rounded-2xl bg-gradient-to-br from-red-500 to-red-600 flex items-center justify-center">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const form = document.getElementById('parodiaForm');
            ...
            const notaLetra = document.getElementById('notaLetra');
            const notaDiccao = document.getElementById('notaDiccao');
            const notaDesempenho = document.getElementById('notaDesempenho');
            const notaTrilha = document.getElementById('notaTrilha');
            ...
            const displayLetra = document.getElementById('displayLetra');
            const displayDiccao = document.getElementById('displayDiccao');
            const displayDesempenho = document.getElementById('displayDesempenho');
            const displayTrilha = document.getElementById('displayTrilha');
            const displayCriatividade = document.getElementById('displayCriatividade');
            const valorTema = document.getElementById('valorTema');
            const valorLetra = document.getElementById('valorLetra');
            const valorDiccao = document.getElementById('valorDiccao');
            const valorDesempenho = document.getElementById('valorDesempenho');
            const valorTrilha = document.getElementById('valorTrilha');
            ...
            function atualizarPontuacaoTotal() {
                ...
                const letra = notaLetra.value !== '' ? parseInt(notaLetra.value) || 0 : 0;
                const diccao = notaDiccao.value !== '' ? parseInt(notaDiccao.value) || 0 : 0;
                const desempenho = notaDesempenho.value !== '' ? parseInt(notaDesempenho.value) || 0 : 0;
                const trilha = notaTrilha.value !== '' ? parseInt(notaTrilha.value) || 0 : 0;
                const criatividade = notaCriatividade.value !== '' ? parseInt(notaCriatividade.value) || 0 : 0;
                
                const total = tema + letra + diccao + desempenho + trilha + criatividade;
                ...
                if ((tema > 0 || letra > 0 || diccao > 0 || desempenho > 0 || trilha > 0 || criatividade > 0) && cursoInput.value) {
            ...
            notaLetra.addEventListener('input', function() {
                atualizarDisplayNota(this, displayLetra, valorLetra);
            });

            notaDiccao.addEventListener('input', function() {
                atualizarDisplayNota(this, displayDiccao, valorDiccao);
            });

            notaDesempenho.addEventListener('input', function() {
                atualizarDisplayNota(this, displayDesempenho, valorDesempenho);
            });

            notaTrilha.addEventListener('input', function() {
                atualizarDisplayNota(this, displayTrilha, valorTrilha);
            });
            ...
            [notaTema, notaLetra, notaDiccao, notaDesempenho, notaTrilha, notaCriatividade].forEach(input => {
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (tema === 0 && letra === 0 && diccao === 0 && desempenho === 0 && trilha === 0 && criatividade === 0) {
                ...
                const inputs = [notaTema, notaLetra, notaDiccao, notaDesempenho, notaTrilha, notaCriatividade];
                ...
                document.getElementById('sucessoParodia').classList.remove('hidden');
            });
            ...
            window.resetForm = function() {
                ...
                displayLetra.classList.add('hidden');
                displayDiccao.classList.add('hidden');
                displayDesempenho.classList.add('hidden');
                displayTrilha.classList.add('hidden');
            ...
            window.fecharSucesso = function() {
                document.getElementById('sucessoParodia').classList.add('hidden');
                resetForm();
            };
            function fecharErro() {
                document.getElementById('erroParodia').classList.add('hidden');
                resetForm();
            }
            function fecharJaConfirmado() {
                document.getElementById('jaConfirmadoParodia').classList.add('hidden');
                resetForm();
            }
            function fecharEmpty() {
                document.getElementById('emptyParodia').classList.add('hidden');
                resetForm();
            }
            ...
            if (status === 'sucesso') {
                ...
                document.getElementById('erroParodia').classList.remove('hidden');
                form.style.display = 'none';
                voltarButton.classList.add('hidden');
            } else if (status === 'ja_confirmado') {
                document.getElementById('jaConfirmadoParodia').classList.remove('hidden');
                form.style.display = 'none';
                voltarButton.classList.add('hidden');
            } else if (status === 'empty') {
                document.getElementById('emptyParodia').classList.remove('hidden');
                form.style.display = 'none';
                voltarButton.classList.add('hidden');
            }
        });
