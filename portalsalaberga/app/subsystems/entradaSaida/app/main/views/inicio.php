  ...
  <div class="container">
    <div>
      <form action="../control/control_index.php" method="post">
        ...
        <button class="menu-btn entrada" type="submit" name="action" value="entrada" onclick="registrar('entrada')">Registrar Entrada</button>

        <button class="menu-btn saida" type="submit" name="action" value="saida" onclick="registrar('saída')">Registrar Saída</button>
