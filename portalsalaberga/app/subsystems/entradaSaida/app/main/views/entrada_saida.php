...
<body>
  ...
  <div class="container">
    ...
    <form id="cadastro-aluno" action="../control/control_index.php" method="POST">
      ...
      <div class="box">
        ...
        <input type="text" name="Nome_resp" placeholder="Nome do Responsável" class="input-field" required>

        <select id="Tipo_resp" name="Tipo_resp" class="input-field" required>
        ...
        <input type="Nome_condu" name="Nome_condu" placeholder="Nome do Conducente" class="input-field">


        <select id="Tipo_condu" name="Tipo_condu" class="input-field">
        ...
        <select id="motivo" name="motivo" class="input-field">
        ...
        <select id="Tipo_User" name="Tipo_User" class="input-field">
          <option value="" disabled selected>Selecione o Tipo de Administrador</option>
        ...
        <input type="time" name="horario" class="input-field" required>

        <button type="submit" class="btn-submit"><span>Cadastrar</span></button>
    </form>
  </div>
  </div>
  </div>
