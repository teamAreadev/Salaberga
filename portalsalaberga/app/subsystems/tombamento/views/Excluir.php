        ...
        <div class="search-bar">
            <div class="message-box">
                ...
                if (isset($_SESSION['mensagem'])) {
                    echo '<div class="success-message">' . htmlspecialchars($_SESSION['mensagem']) . '</div>';
    ...
    <script>
        function confirmDelete(id_bem) {
            if (confirm('Tem certeza que deseja excluir o item ' + id_bem + '? Esta ação não pode ser desfeita.')) {
                ...
                console.log('URL completa:', window.location.origin + '/sistema-tombamento/controllers/BemController.php');
                fetch('/sistema-tombamento/controllers/BemController.php', {
                    method: 'POST',
                    headers: {
