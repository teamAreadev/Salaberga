...
class EntradaPDFAlunoIndividual
{
    private $db;
    private $connect;
    ...
    public function pdf()
    {
        ...
        $pdf->Cell(0, 30, mb_convert_encoding('Relatório de Entrada - Aluno Individual', 'ISO-8859-1', 'UTF-8'), 0, 1, 'C');
        ...
        if (!$id_aluno) {
            ...
            header('Location: ../relatorioEntrada.php?error=invalid_aluno');
            exit();
        }
        ...
        $entradaModel = new EntradaPDF();
        $dados = $entradaModel->getSaidasByDateRange($id_aluno, $startDate, $endDate);
