...
class EntradaPDFPorTurma
{
    ...
    public function pdf()
    {
        ...
        $pdf->Cell(0, 30, mb_convert_encoding('Relatório de Entrada - Por Turma', 'ISO-8859-1', 'UTF-8'), 0, 1, 'C');
        ...
        if (!$id_turma || $id_turma < 1 || $id_turma > 12) {
            ...
            header('Location: ../relatorioEntrada.php?error=invalid_turma');
            exit();
        }
        ...
        // Título da turma (agora usando o nome completo da turma)
