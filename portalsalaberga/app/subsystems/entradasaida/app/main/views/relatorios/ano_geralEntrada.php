...
class EntradaPDFAnoGeral
{
    ...
    public function pdf()
    {
        ...
        $pdf->Cell(0, 30, mb_convert_encoding('Relatório de Entrada - Ano Geral', 'ISO-8859-1', 'UTF-8'), 0, 1, 'C');
        ...
        if (!$ano || $ano < 1 || $ano > 3) {
            ...
            header('Location: ../relatorioEntrada.php?error=invalid_ano');
            exit();
        }
