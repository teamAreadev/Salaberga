...
<body>
  ...
  <div class="container">
    ...
    <form id="registro-e" action="../control/control_index.php" method="POST">
    ...
    ?>
      ...
      <div class="box">
        ...
        <input type="text" id="nome_conducente" name="nome_conducente" placeholder="Nome do Acompanhante" class="input-field">


        <select id="id_tipo_conducente" name="id_tipo_conducente" class="input-field">
          <option value="" disabled selected>Selecione o Tipo de Acompanhante</option>
        ...
        <input id="btn" type="submit" value="Registrar" name="entrada" class=" btn-submit" method="POST">
    </form>
  </div>
  </div>
  </div>
