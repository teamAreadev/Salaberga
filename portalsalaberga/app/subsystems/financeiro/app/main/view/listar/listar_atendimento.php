...
<head>
    ...
    <title>Declarações de Atendimento - Sistema Financeiro</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="mb-0"><i class="fas fa-file-alt me-2"></i>Declarações de Atendimento</h4>
                <div class="d-flex gap-2">
                    <a href="../inicial.php" class="btn btn-secondary btn-sm">
                        <i class="fas fa-arrow-left me-2"></i>Voltar ao inicio
                    </a>
                    <a href="../relatorios/relatorio_atendimento.php" class="btn btn-secondary btn-sm" target="_blank">
                        <i class="fas fa-file-pdf me-2"></i>Gerar Relatório
                    </a>
                    <a href="../forms/form_atendimento.html" class="btn btn-primary btn-sm">
                        <i class="fas fa-plus me-2"></i>Novo Documento
                    </a>
                </div>
            </div>
            <div class="card-body">
                <form id="formExcluir" method="post" action="excluir/excluir_atendimento.php">
                    <div class="mb-3">
                                ...
                                if ($res->num_rows > 0) {
                                    while ($row = $res->fetch_assoc()) {
                                        echo "<tr>
                                            ...
                                            <td>{$row['gestor']}</td>
                                            <td>";
                                        echo "<a href='../gerar/" . $row['caminho_pdf'] . "' target='_blank' class='btn btn-primary btn-sm'><i class='fas fa-file-pdf me-1'></i>Ver PDF</a>";
                                        echo "</td>";
                                        echo "<td>{$row['criado_em']}</td>
                                        </tr>";
                                    }
                                } else {
                                    echo "<tr><td colspan='9' class='text-center'>Nenhuma declaração encontrada.</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
