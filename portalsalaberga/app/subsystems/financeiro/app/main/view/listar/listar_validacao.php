...
<head>
    ...
    <title>Declarações de Validação - Sistema Financeiro</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="mb-0"><i class="fas fa-file-alt me-2"></i>Declarações de Validação</h4>
                <div class="d-flex gap-2">
                    <a href="../inicial.php" class="btn btn-secondary btn-sm">
                        <i class="fas fa-arrow-left me-2"></i>Voltar ao inicio
                    </a>
                    <a href="../relatorios/relatorio_validacao.php" class="btn btn-secondary btn-sm" target="_blank">
                        <i class="fas fa-file-pdf me-2"></i>Gerar Relatório
                    </a>
                    <a href="../forms/form_validacao.html" class="btn btn-primary btn-sm">
                        <i class="fas fa-plus me-2"></i>Novo Documento
                    </a>
                </div>
            </div>
            <div class="card-body">
                <form id="formExcluir" method="post" action="excluir/excluir_validacao.php">
                    <div class="mb-3">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                if ($res->num_rows > 0) {
                                    ...
                                    echo "<tr><td colspan='8' class='text-center'>Nenhuma declaração de validação encontrada.</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
