...
$numero_loa = $_POST['numero_loa'] ?? '';
$data_loa = $_POST['data_loa'] ?? '';
...
// === NOME DO PDF ===
$nome_arquivo = 'loa_' . preg_replace('/[^0-9]/', '', $nup) . '_' . date('Ymd_His') . '.pdf';
...
$pdf->Cell(0, 8, utf8_decode('DECLARAÇÃO DA LOA'), 0, 1, 'C');
$pdf->Ln(5);
...
// === Insere no banco ===
$stmt = $conn->prepare("INSERT INTO loa (numero_loa, data_loa, dotacao, ordenador, caminho_pdf) VALUES (?, ?, ?, ?, ?)");
$stmt->bind_param("sssss", $numero_loa, $data_loa, $dotacao, $ordenador, $caminho);
$stmt->execute();
...
<head>
    ...
    <title>LOA Gerada - Sistema Financeiro</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">LOA Gerada com Sucesso!</h5>
                </div>
                <div class="modal-body text-center">
                    <i class="fas fa-check-circle success-icon"></i>
                    <p class="success-message">A LOA foi gerada e salva com sucesso.</p>
