...
// === NOME DO PDF ===
$nome_arquivo = 'pca_' . preg_replace('/[^0-9]/', '', $nup) . '_' . date('Ymd_His') . '.pdf';
...
$pdf->Cell(0, 8, utf8_decode('DECLARAÇÃO DO PLANO DE CONTRATAÇÃO ANUAL'), 0, 1, 'C');
$pdf->Ln(5);
...
// Registro no banco
$stmt = $conn->prepare("INSERT INTO pca (natureza, nup, escola, ordenador, caminho_pdf) VALUES (?, ?, ?, ?, ?)");
...
<head>
    ...
    <title>PCA Gerado - Sistema Financeiro</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">PCA Gerado com Sucesso!</h5>
                </div>
                <div class="modal-body text-center">
                    <i class="fas fa-check-circle success-icon"></i>
                    <p class="success-message">O PCA foi gerado e salvo com sucesso.</p>
