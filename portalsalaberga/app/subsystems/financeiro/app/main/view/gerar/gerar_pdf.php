...
// === NOME DO PDF ===
$nome_arquivo = 'declaracao_' . preg_replace('/[^0-9]/', '', $nup) . '_' . date('Ymd_His') . '.pdf';
...
$pdf->Cell(0, 8, utf8_decode('DECLARAÇÃO'), 0, 1, 'C');
$pdf->Ln(5);
...
// === REGISTRO NO BANCO ===
$stmt = $conn->prepare("INSERT INTO autoridade (nup, natureza, diretor, caminho_pdf) VALUES (?, ?, ?, ?)");
$stmt->bind_param("ssss", $nup, $natureza, $ordenador, $caminho_pdf);
$stmt->execute();
