...
if (!isset($_SESSION['usuario'])) {
    header("Location: ../view/login.php?error=Por favor, faça login para acessar o portal");
    exit();
}
...
<head>
    ...
    <title>EEEP STGM - Portal do Aluno</title>
    ...
    <style>
        ...
        .banner {
            width: 100%;
            height: 350px;
            background: url('https://via.placeholder.com/1200x350?text=Portal+do+Aluno+EEEP+STGM') no-repeat center;
...
<body>
    ...
    <div class="banner">
        <div class="banner-overlay">
            ...
            <p>Gerencie suas atividades escolares com facilidade e acesse serviços importantes.</p>
        </div>
    </div>
    ...
    <main class="content">
        <div class="welcome-message">
            ...
            <p>Explore os recursos disponíveis no portal para acompanhar sua rotina escolar.</p>
        </div>
        <div class="cards-container">
            <div class="card" onclick="redirectWithLoading('cardapio.php')">
                <div class="card-icon">
                    <i class="fas fa-utensils"></i>
                </div>
                <h3>Visualizar Cardápio</h3>
                <p>Consulte as refeições disponíveis diariamente e acesse o histórico de cardápios anteriores.</p>
            </div>

            <div class="card" onclick="redirectWithLoading('avaliacao.php')">
                <div class="card-icon">
                    <i class="fas fa-star"></i>
                </div>
                <h3>Avaliação das Refeições</h3>
                <p>Avalie as refeições fornecidas pela escola para auxiliar na melhoria do cardápio.</p>
            </div>
        </div>
    </main>
